...
export class TorneosService {
  ...
  async create(createTorneoDto: CreateTorneoDto): Promise<Torneo> {
    try{
      let torneo: Torneo = await this.torneoRepository.save(new Torneo(createTorneoDto.nroTorneo, createTorneoDto.fecha, createTorneoDto.horaInicio, createTorneoDto.horaCierre));
